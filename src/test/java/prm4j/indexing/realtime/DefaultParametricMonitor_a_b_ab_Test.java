...
public class DefaultParametricMonitor_a_b_ab_Test extends AbstractDefaultParametricMonitorTest {
    ...
    @Test
    public void a1_b1_a1b1_match() throws Exception {
	// exercise
	pm.processEvent(fsm.e1.createEvent(a1));
	pm.processEvent(fsm.e2.createEvent(b1));
	pm.processEvent(fsm.e3.createEvent(a1, b1));
    ...
    @Test
    public void b1_a1_b1_a1b1_nomatch() throws Exception {
	// exercise
	pm.processEvent(fsm.e2.createEvent(b1)); // disable traceslice a1b1
	pm.processEvent(fsm.e1.createEvent(a1));
	pm.processEvent(fsm.e2.createEvent(b1));
	pm.processEvent(fsm.e3.createEvent(a1, b1));

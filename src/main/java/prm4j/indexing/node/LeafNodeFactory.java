...
public class LeafNodeFactory extends NodeFactory {

    private final NodeManager nodeManager;

    public LeafNodeFactory(NodeManager nodeManager) {
	this.nodeManager = nodeManager;
    }

    @Override
    public Node createNode(ParameterNode parameterNode, int parameterIndex, Binding binding) {
	Node node = new LeafNode(parameterNode, binding, nodeManager.getReferenceQueue());

...
public abstract class JDKAbstractMap<K, V> implements Map<K, V> {
    /**
     * Sole constructor. (For invocation by subclass constructors, typically implicit.)
     */
    protected JDKAbstractMap() {
    }
	...
	if (keySet == null) {
		...
		@Override
		public int size() {
		    return JDKAbstractMap.this.size();
		}

		@Override
		public boolean contains(Object k) {
		    return JDKAbstractMap.this.containsKey(k);
		}
	    };
	}
	return keySet;
	...
	if (values == null) {
		...
		public boolean contains(Object v) {
		    return JDKAbstractMap.this.containsValue(v);
		}
	    };
	}
	return values;
	...
	JDKAbstractMap<K, V> result = (JDKAbstractMap<K, V>) super.clone();
	result.keySet = null;
	result.values = null;
	return result;
    }
